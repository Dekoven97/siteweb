(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function d(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerpolicy&&(a.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?a.credentials="include":s.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(s){if(s.ep)return;s.ep=!0;const a=d(s);fetch(s.href,a)}})();const v="/vite_test/assets/wave1-169d6c69.svg",p="/vite_test/assets/me-e5e32b55.png",m="/vite_test/assets/back1-a835d9b3.svg",_="/vite_test/assets/html-4bf19408.png",u="/vite_test/assets/css-a1799679.png",g="/vite_test/assets/php-b36213f9.png",f="/vite_test/assets/js-5b6307db.png",h="/vite_test/assets/bootstrap-d63609cf.png",b="/vite_test/assets/wordpress-76dda9d5.png",k="/vite_test/assets/laravel-cc0747c8.png",w="/vite_test/assets/angular-99f6e56b.png";document.querySelector("#head").innerHTML=`
...
`;window.onscroll=function(){L()};var t=document.getElementById("menu"),y=t.offsetTop;function L(){window.pageYOffset>y?t.classList.add("sticky"):t.classList.remove("sticky")}const o=document.querySelectorAll(".menu-item"),n=document.querySelectorAll("section");function c(){let e=n.length;for(;--e&&window.scrollY+50<n[e].offsetTop;);o.forEach(i=>i.classList.remove("active")),o[e].classList.add("active")}c();window.addEventListener("scroll",c);$("#cb").click(function(e){$("#active").click(function(i){i.stopPropagation()}),$("#active").prop("checked",!$("#active").prop("checked"))});$("#b").click(function(e){$("#active").click(function(i){i.stopPropagation()}),$("#active").prop("checked",!$("#active").prop("checked"))});$("#d").click(function(e){$("#active").click(function(i){i.stopPropagation()}),$("#active").prop("checked",!$("#active").prop("checked"))});$("#e").click(function(e){$("#active").click(function(i){i.stopPropagation()}),$("#active").prop("checked",!$("#active").prop("checked"))});$("#f").click(function(e){$("#active").click(function(i){i.stopPropagation()}),$("#active").prop("checked",!$("#active").prop("checked"))});$("#g").click(function(e){$("#active").click(function(i){i.stopPropagation()}),$("#active").prop("checked",!$("#active").prop("checked"))});document.querySelector("#about").innerHTML=`
...
<div class="parent">
<div class="div1  skills_item">  <a href="https://developer.mozilla.org/en-US/docs/Web/HTML"  target="_blank"   rel="noreferrer noopener" > <img class="logo_size hvr-grow  " src="${_}"       /> </a> </div>
<div class="div2  skills_item">   <a href="https://developer.mozilla.org/en-US/docs/Web/CSS"  target="_blank"   rel="noreferrer noopener" > <img  class="logo_size  hvr-grow " src="${u}"     />   </a>  </div>
<div class="div3  skills_item">   <a href="https://www.php.net/"  target="_blank"   rel="noreferrer noopener" > <img  class="logo_size  hvr-grow " src="${g}"     />  </a>   </div>
